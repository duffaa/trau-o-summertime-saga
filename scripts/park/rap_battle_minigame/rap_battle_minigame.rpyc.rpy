...
label rapbattle_listing:
    ...
    $ chico1 = Rap(line = "Chico, por que você é tão bicha?\nSua boca precisa de ____.", rhymes = ["uma salsicha", "uma ajuda", "um beijo"], answer = "uma salsicha")
    $ chico2 = Rap(line = "Tem certeza que seu nome não é Ricardo?\nPorque você é um ____.", rhymes = ["retardado", "babaca", "gay"], answer = "retardado")
    $ chico_list = [chico1, chico2]
    $ chico3 = Rap(line = "Você não tem nada de zica.\nMas parece a minha ____.", rhymes = ["pica", "mão", "isca"], answer = "pica")
    $ chico4 = Rap(line = "Se curve e respeite o meu flow.\nPois agora vai começar o meu ____.", rhymes = ["show", "rap", "momento"], answer = "show")
