...
label home_front:
    ...
    if M_mom.get_state() == S_mom_mrsj_visit and not gTimer.is_dark():
        ...
        show mom 164f
        show erikmom 17
        erimom "Quis parar para dizer que sinto muito pela sua perda..."
        show mom 165f
        show erikmom 14
        mom "Oh, obrigada. Foi muito... gentil da sua parte."
        show mom 169f
        show erikmom 19
        erimom "Só quero que saiba que estarei de portas abertas sempre que você precisar de algo."
        erimom "Ou de alguém para conversar."
        show mom 168f
        show erikmom 14
        mom "Isso é muito generoso."
        show mom 169f
        show erikmom 17
        erimom "Sei que são situações diferente, mas eu te entendo, sabe?"
        show mom 168f
        show erikmom 14
        mom "Você quis dizer, por causa do seu marido?"
        show mom 169f
        show erikmom 17
        erimom "Isso!"
        show erikmom 20
        erimom "Digo, meu marido me deixou... então é um pouco diferente."
        show erikmom 18
        erimom "Mas eu me virei sozinha por muito tempo!"
        show mom 168f
        show erikmom 14
        mom "Você não se sente sozinha?"
        mom "É difícil com você e seu filho sozinhos em casa?"
        show mom 169f
        show erikmom 20
        erimom "Sim... {b}Erik{/b} ficou triste quando eu disse que o pai dele nunca mais voltaria..."
        show erikmom 17
        erimom "... mas não se preocupe!"
        erimom "Sempre tem maneiras de se animar os garotos, sabe? Tenho umas táticas..."
        show mom 168f
        show erikmom 14
        mom "Oh, sério? Tipo o que?"
        show mom 169f
        show erikmom 17
        erimom "Garotas gostam de atenção emocional, mas garotos..."
        show mom 169bf
        erimom "... Você precisar dar atenção {b}física{/b}!"
        show mom 169f
        erimom "Sabe... tipo abraços, carinho e amor materno!"
        show mom 168f
        show erikmom 14
        mom "Entendi..."
        show mom 169f
        show erikmom 18
        erimom "{b}Erik{/b} ficou MUITO melhor desde que comecei a satisfazer seus... desejos."
        show mom 168f
        show erikmom 14
        mom "Mas não sei se sou forte o suficiente para superar isso..."
        show mom 169f
        show erikmom 17
        erimom "Olha, querida. Se eu pude, você também pode."
        erimom "Foque nos seus filho, foi isso que eu fiz!"
        erimom "Você tem que pensar no que eles querem."
        show mom 168f
        show erikmom 14
        mom "Acho que você está certa."
        show mom 169f
        pause
        ...
        show mom 164f
        show player 14
        player_name "Oi, {b}[mom_name]{/b}... Oi, {b}Sra. Johnson{/b}!"
        show player 1
        show erikmom 17
        erimom "Olá, {b}[firstname]{/b}."
        erimom "Sua mãe estava me dizendo o quanto ela se importa com você..."
        show erikmom 14
        show player 14
        player_name "Oh, heh..."
        show erikmom 17
        show player 13
        erimom "Ela te ama muito, então, é melhor que você tome cuidado dela!"
        show erikmom 14
        show player 14
        player_name "Uhh... Claro."
        show player 1
        show erikmom 17
        erimom "..."
        erimom "Bem, eu vou deixar você voltar para casa..."
        show erikmom 14
        show mom 165f
        mom "Certeza que não quer entrar?"
        show mom 164f
        show erikmom 17
        erimom "Não, está tudo bem! Eu tenho que ir para casa. {b}Erik{/b} precisa de ajuda com... algo."
        show erikmom 14
        show mom 165f
        mom "Bom, nesse caso, obrigado pela conversa! Volte mais tarde!"
        show mom 164f
        show erikmom 17
        erimom "Oh, eu vou, querida!"
        ...
        show text "Isso é muito mais difícil do que eu imaginava. Eu deveria ter prestado mais atenção ao pai quando ele costumava fazer isso." at Position (xpos= 512, ypos = 700) with dissolve
        $ renpy.pause ()
        ...
        show text "Não parece tão ruim. Espero que {b}[mom_name]{/b} também ache isso." at Position (xpos= 512, ypos = 700) with dissolve
        $ renpy.pause ()
        hide text with dissolve

        show cutting_grass_03 with dissolve
        show text "Ela está ali parada. Eu estava tão focado em cortar a grama, eu nem percebi que ela saiu." at Position (xpos= 512, ypos = 700) with dissolve
        $ renpy.pause ()
        hide text with dissolve
        ...
        show mom 1 at right
        with dissolve
        player_name "{b}Mãe{/b}, terminei com o gramado."
        show player 203
        show mom 2
